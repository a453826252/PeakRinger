package com.zaz.support.widget
 ...
 * link:https://github.com/WeiLianYang/RoundImageView/tree/main
 *
 * 使用方式：
 *
...
class RoundImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : AppCompatImageView(context, attrs, defStyleAttr) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (radius > 0 || topLeftRadius > 0 || topRightRadius > 0 || bottomLeftRadius > 0 || bottomRightRadius > 0) {
            ...
            if (roundAsCircle) {
                ...
                val radii = floatArrayOf(topLeftRadius, topLeftRadius, topRightRadius, topRightRadius, bottomRightRadius, bottomRightRadius, bottomLeftRadius, bottomLeftRadius)

                borderRectF.set(paddingLeft.toFloat() + halfBorderWidth, paddingTop.toFloat() + halfBorderWidth, measuredWidth.toFloat() - paddingRight - halfBorderWidth, measuredHeight.toFloat() - paddingBottom - halfBorderWidth)
                ...
                rectF.set(paddingLeft.toFloat(), paddingTop.toFloat(), measuredWidth.toFloat() - paddingRight, measuredHeight.toFloat() - paddingBottom)
     ...
     * @param borderColor 外边框颜色
     */
    fun setRadiusAndBorder(topLeftRadius: Float = 0f, topRightRadius: Float = 0f, bottomLeftRadius: Float = 0f, bottomRightRadius: Float = 0f, borderWidth: Float = 0f, @ColorInt borderColor: Int = 0) {
